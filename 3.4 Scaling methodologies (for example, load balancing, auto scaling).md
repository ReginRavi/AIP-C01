...
flowchart TD
    subgraph Global_DNS ["1. Edge & DNS Tier"]
        R53["Amazon Route 53"] --> CF["Amazon CloudFront CDN"]
    end
    ...
    subgraph Auto_Scaling_Fleet ["3. Multi-AZ EC2 Auto Scaling Tier"]
        ...
        WarmPool["ASG Warm Pool (Standby EC2s)"] -.->|"Instant Scale Out"| Auto_Scaling_Fleet
    end

    subgraph Externalized_State ["4. Stateless Session & Database Tier"]
        EC2_AZ1 & EC2_AZ2 & EC2_AZ3 ==> Cache["ElastiCache / DynamoDB (Session Store)"]
        EC2_AZ1 & EC2_AZ2 & EC2_AZ3 ==> DB["Amazon RDS / Aurora (Multi-AZ Data Store)"]
    end
...
flowchart TD
    ...
    Q_Policy -- "Severe stepped traffic threshold breaches" --> StepScale["Step Scaling Policy<br/>(CPU > 60% -> +1 instance; CPU > 85% -> +4 instances)"]
