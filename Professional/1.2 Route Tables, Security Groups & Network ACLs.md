...
> **Start with the minimum control that satisfies the security requirement. Prefer Security Groups for normal workload isolation because they are stateful, scalable, and low operational overhead. Add NACLs when you specifically need subnet-level controls or explicit denies. Add Network Firewall when you need advanced centralized inspection—not simply because "more security" sounds better.**