...
# 90. Exam Trap — Commitment Purchase
Analyze usage in **Cost Explorer** first before committing to Savings Plans or RIs.

---

# 91. Exam Trap — Underutilized Resources
- Broad best-practice checks $\longrightarrow$ **Trusted Advisor**.
- Resource-specific rightsizing recommendations $\longrightarrow$ **Compute Optimizer**.
