...
`Measure & Rightsize First ➔ Automate Elasticity (Auto Scaling / Serverless) ➔ Apply Commitment Discounts (Savings Plans / RIs / Spot + Spot Draining) ➔ Automated Lifecycle Storage (S3 Standard -> Glacier -> Expiration)`