...
`All-at-Once (Fast/Cheapest/Risk) ➔ Rolling (Batches/Zero Extra Cost) ➔ Blue/Green (Isolated/Instant Rollback) ➔ Canary (Minimal Blast Radius) ➔ CodeDeploy (Hybrid EC2 + On-Premises Support)`